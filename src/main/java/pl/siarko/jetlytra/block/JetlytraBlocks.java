...
public class JetlytraBlocks {
    public static final DeferredRegister<net.minecraft.world.level.block.Block> BLOCKS =
            DeferredRegister.create(Registries.BLOCK, Jetlytra.MODID);

    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY_TYPES =
            DeferredRegister.create(Registries.BLOCK_ENTITY_TYPE, Jetlytra.MODID);

    public static final DeferredHolder<net.minecraft.world.level.block.Block, JetpackBlock> JETPACK =
            BLOCKS.register("jetpack", JetpackBlock::new);
